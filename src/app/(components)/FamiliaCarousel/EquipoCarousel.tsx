...
const carouselImages = [
    {
        url: "/carousel/equipo/carousel_img1.png",
        name: ""
    },
    {
        url: "/carousel/equipo/carousel_img2.png",
        name: ""
    },
    {
        url: "/carousel/equipo/carousel_img3.png",
        name: ""
    },
    {
        url: "/carousel/equipo/carousel_img1.png",
                ...
                <div className="col-span-2">
                    <div className="flex justify-start items-center gap-4">
                        <Image
                            ...
                            alt="arrow"
                        />
                        <p className="text-orange-500 font-medium text-lg xl:text-xl">Testimonios</p>
                    </div>
                    <Heading1 className="text-[#087E8A] md:h-10 xl:h-16 text-start">Familias Beneficiadas</Heading1>
                    <Paragraph className="text-start">
                    Agradecidos  por la confianza de hacer realidad el sueño del lote propio.
                    </Paragraph>
                </div>
