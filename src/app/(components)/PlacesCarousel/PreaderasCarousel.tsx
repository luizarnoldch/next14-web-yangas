...
const carouselImages = [
    {
        url: "/carousel/carousel_img1.png",
        name: "Plaza de Santa Rosa de Quives"
    },
    {
        url: "/carousel/carousel_img2.png",
        name: "Santa Rosa de Quivez"
    },
    {
        url: "/carousel/carousel_img3.png",
        name: "Machu Picchu Limeño"
    },
    {
        url: "/carousel/carousel_img1.png",
        name: "Plaza de Santa Rosa de Quives"
...
export default function PreaderasCarousel() {
    return (
        <Carousel
            opts={{
                align: "start",
        ...
        >
            <div className="grid grid-cols-3 items-center gap-x-2">
                <div className="col-span-2">
                    <Heading1 className="text-[#087E8A] md:h-10 xl:h-16 text-start">Praderas de Yangas</Heading1>
                    <Paragraph className="text-start">
                        Lugares turísticos que podrás visitar cerca a tu nuevo lote en Praderas de Yangas
                    </Paragraph>
                </div>
